...
load data
```{r}
stance_main<-read_csv("../2_data/df_tab2_stance_main.csv")
stance_clim_narratives<-read_csv("../2_data/df_tab2_stance_clim_narratives.csv")
stance_tax<-read_csv("../2_data/df_tab2_stance_tax.csv")
```
